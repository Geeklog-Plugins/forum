...
$indextemplate->set_var('totalcats', COM_numberFormat($totalcats));
$indextemplate->set_var('totalforumsmsg', $LANG_GF91['totalforums']);
$indextemplate->set_var('totalforums', COM_numberFormat($totalforums));
$indextemplate->set_var('totaltopicsmsg', $LANG_GF91['totaltopics']);
$indextemplate->set_var('totaltopics', COM_numberFormat($totaltopics));
$indextemplate->set_var('totalpostsmsg', $LANG_GF91['totalposts']);
$indextemplate->set_var('totalposts', COM_numberFormat($totalposts));
$indextemplate->set_var('totalviewsmsg', $LANG_GF91['totalviews']);
$indextemplate->set_var('totalviews', COM_numberFormat($totalviews['TOTAL']));
...
$indextemplate->set_var('avgcposts', COM_numberFormat($avgcposts));
$indextemplate->set_var('avgfposts', COM_numberFormat($avgfposts));
$indextemplate->set_var('avgtposts', COM_numberFormat($avgtposts));
$indextemplate->set_var('avgvmsg', $LANG_GF91['avgvmsg']);
$indextemplate->set_var('avgcviews', COM_numberFormat($avgcviews));
$indextemplate->set_var('avgfviews', COM_numberFormat($avgfviews));
$indextemplate->set_var('avgtviews', COM_numberFormat($avgtviews));
