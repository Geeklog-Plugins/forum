...
$LANG_GF02 = array(
	...
	'msg23c' => "You may view the reply at:\n%s\n";
	'msg23d' => "An edit has been made to a post in the thread '%s' by %s.\n\nThis topic was started by %s in the %s forum. ";
	'msg23e' => "You may view the edited post at:\n%s\n";
    'msg25' => "\n¡Que tengas un gran día! \n",
    'msg26' => "\nEstas recibiendo este mensaje por que has elegido ser notificado cuando hubiera una respuesta a este tópico. Para dejar de recibir notificaciones en este tópico ve a %s para eliminarlas.\n",
