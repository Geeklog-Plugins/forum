...
$LANG_GF01['loginreqpost']   = 'Merci de vous inscrire ou vous identifier pour utiliser ce forum. Vous allez être redirigé.';
...
$LANG_GF01['USERPREFS']      = 'Préférences';
...
$LANG_GF01['ACCESSERROR']    = 'Accès réservé aux membres';
...
$LANG_GF02['msg74']    = '%s dernières contributions publiées';
...
$LANG_GF02['msg143']   = 'Notification sauvegardée mais aucune adresse email est associée avec votre compte ou elle est non valide. Merci d\'en ajouter une à <a href="/usersettings.php">votre compte</a> ou vous ne recevrez pas de notifications.';
$LANG_GF02['msg144']   = 'Retourner au sujet';
$LANG_GF02['msg145']   = 'Aucune adresse email est associée avec votre compte ou elle est non valide. Merci d\'en ajouter une à <a href="/usersettings.php">votre compte</a> ou vous ne recevrez pas de notifications.';
...
$LANG_GF02['msg149']   = 'Publication effacée.';
...
$LANG_GF02['by']   = 'Par';
$LANG_GF02['replies']   = 'Réponses';
$LANG_GF02['views']   = 'Vues';
$LANG_GF02['forumsearchresults']   = 'Résultats des recherches dans le Forum';
$LANG_GF02['forumsearchfor']   = 'Résultats des recherches dans le Forum pour "%s"';
$LANG_GF02['msg202']   =  'Pas de nouvelles contributions';
$LANG_GF02['msg203']   = 'Aucune publications trouvées.';
...
$LANG_GF03 = array (
    ...
    'banippostremove'   => 'Débannir l\'IP des publications',
    'banip'             => 'Bannir l\'IP du site',
    'banipremove'       => 'Débannir l\'IP du site',
    'banipmsg'      	=> 'L\'IP a été bannie du site',
    'banipremovemsg'	=> 'Bannissement supprimé du iste pour l\'IP',  
    'movetopic'         => 'Déplacer et créer un nouveau fil',
    'movetopicmsg'      => 'Sujet à déplacer : "<b>%s</b>"',
    'splittopicmsg'     => 'Créer un nouveau sujet avec ce message "<b>%s</b>" de %s le %s',
...
$LANG_GF92 = array (
    ...
    'newppdscp'          => 'Nombre de publications à afficher sur la page des nouvelles publications',
    'popularpp'     	 => 'Publictions populaires par page',
    'popularppdscp'      => 'Nombre de publicationsà afficher sur la page des publications populaires',
    'popularl'     		 => 'Limite de popularité',
    'popularldscp'       => 'Nombre de publications ou de vues pour appeler un sujet populaire',
    'searchpp'         	 => 'Résultats d\'une recherche par page',
    'searchppdscp'       => 'Nombre de résultats à afficher sur la page des recherches',
    ...
    'viewapdscp'         => 'Paramétrer à Non filtrera les publications anonymes',
    'alwaysn'            => 'Toujours notifier',
    'alwaysndscp'        => 'Paramétrer à Oui activera la notification automatique pour tous les sujets que vous créez ou auquels vous répondez',
    'notifyoo'			 => 'Notifier une fois seulement', 
    'notifyoodscp'   	 => 'Les notifications seront expédiées une seule fois pour les sujets ou les forums qui plusieurs nouvelles contributions depuis votre dernière visite.', 
...
$LANG_GF93 = array (
    ...
    'forumnotmerged'     => 'Le Forum ne peut être fusionner car il n\'y a aucun autre Forum à fusionner.',
    ...
    'deleteforumnote'   => 'Voulez-vous effacer le forum <b>"%s"</b> ? Tous les sujets postés en dessous vont être aussi effacés.',
    'mergeforumnote'   => 'Fusionner le forum <b>"%s"</b> dans :',
    'editcatnote'        => 'Edition des caractéristiques de la catégorie : <b>"%s"</b>',
    'deletecatnote'     => 'Voulez-vous effacer la catégorie <b>"%s"</b> ? Tous les forums et sujets postés sous ce forum vont être aussi effacés.',
    ...
    'moderatorwarningtitle'   => 'Attention: Aucun forum n\'est défini',
    'moderatorwarning'   => 'Configurez les catégories du forum et ajoutez au moins 1 forum avant d\'essayer d\'ajouter des modérateurs',
    'nomoderatorfound'   => "Aucun modérateurs trouvés.",
    'modadded'   		 => "Modérateur(s) ajouté(s).",
    'moddeleted'   		 => "Modérateur(s) supprimé(s).",
    'modedited'   		 => "Modérateur(s) édité(s).",
    'private'            => 'Forum privé',
...
$LANG_GF96 = array (
    ...
    'ipnotvalid'         => 'L\'adresse IP n\'est pas valide. Elle n\'a pas été ajoutée.',
...
$LANG_fs['forum'] = array(
    ...
    'fs_sideblock'    => 'Bloc latéral',
    'fs_sideblock_settings' => 'Paramétres', 
    'fs_sideblock_permissions' => 'Permissions',  
    'fs_rank'         => 'Les niveaux',
    'fs_menublock'    => 'Bloc navigation',
    'fs_menublock_settings' => 'Paramétres', 
...
$LANG_configselects['forum'] = array(
    ...
    15 => array('All' => TOPIC_ALL_OPTION, 'Page d\'accueil seulement' => TOPIC_HOMEONLY_OPTION, 'Choisir les catégories' => TOPIC_SELECTED_OPTION),
